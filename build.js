...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewsListContainer = __webpack_require__(222);

	var _NewsListContainer2 = _interopRequireDefault(_NewsListContainer);

	var _DetailContainer = __webpack_require__(226);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/', component: App },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: _NewsListContainer2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/', component: _NewsListContainer2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/detail/:newsId', component: _DetailContainer2.default })
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewsList = __webpack_require__(223);
	...
	var NewsListContainer = function (_React$Component) {
	    _inherits(NewsListContainer, _React$Component);

	    function NewsListContainer() {
	        _classCallCheck(this, NewsListContainer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NewsListContainer).apply(this, arguments));
	    }
	    ...
	    _createClass(NewsListContainer, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_NewsList2.default, { url: '/data.json' }),
	...
	exports.default = NewsListContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _load = __webpack_require__(224);

	var _load2 = _interopRequireDefault(_load);

	var _NewsItem = __webpack_require__(225);
	...
	var NewsList = function (_React$Component) {
	    ...
	    function NewsList(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewsList).call(this, props));
	    ...
	    _createClass(NewsList, [{
	        ...
	        value: function componentDidMount() {
	            var initialData = (0, _load2.default)(this.props.url);
	            this.setState({
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.state.news.map(function (item, i) {
	                    return _react2.default.createElement(_NewsItem2.default, { key: item.id, id: item.id, date: item.date, title: item.title, image: item.image, decription: item.shortdecription, more: _this2.showDetail });
	                }),
	                _react2.default.createElement('div', { className: 'clearfix' })
	            );
	        }
	...
	var NewsItem = function (_React$Component) {
	    ...
	    _createClass(NewsItem, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'col-sm-6 col-md-4 news-item' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'thumbnail' },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _reactRouter.Link,
	                                { to: '/detail/' + id, className: 'btn btn-success' },
	                                'More'
	                            )
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DetailItem = __webpack_require__(227);
	    ...
	    _createClass(DetailContainer, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-6 col-xs-12 thumbnail' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'caption' },
	                        _react2.default.createElement(_DetailItem2.default, { url: '/data.json', id: this.props.params.newsId }),
	                        _react2.default.createElement(
	                            'p',
	                            null,
	                            _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DetailItem = function (_React$Component) {
	    _inherits(DetailItem, _React$Component);

	    function DetailItem(props) {
	        _classCallCheck(this, DetailItem);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DetailItem).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".news-item {\n  min-height: 650px; }\n\n.news-detail {\n  padding: 20px 0 50px; }\n  .news-detail h1 {\n    margin: 0 0 20px;\n    font-size: 36px; }\n  .news-detail p {\n    font-size: 16px;\n    line-height: 1.5; }\n    .news-detail p small {\n      color: grey; }\n  .news-detail img {\n    margin: 0 0 15px;\n    max-width: 100%; }\n", ""]);
